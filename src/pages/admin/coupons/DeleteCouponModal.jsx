...
import { deleteCoupon } from './couponsStorage'
...
export default function DeleteCouponModal({ coupon, onCancel, onDeleted }) {
  ...
  const onConfirm = async () => {
    ...
    try {
      ...
      setError(e?.message || 'Unable to delete coupon')
      setDeleting(false)
    }
  }

  return (
    <ModalShell title="Delete Coupon" onClose={onCancel}>
      <div className="text-sm font-semibold text-muted">
        Are you sure you want to delete <span className="font-extrabold text-ink">{coupon.code}</span>? This action cannot be undone.
      </div>
